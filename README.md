...
Some testnet NERO from the NERO Faucet
Initialization
...
Navigate to the `evm-contracts` folder.
...
```bash
   ...
   ```
Take the resulting contract address and update the `CONTRACT_ADDRESS` constant in `lib/nero.js`.
---
<p align="center">
